...
import com.phelat.tedu.di.builder.MobileComponentBuilder
...
class Tedu : DaggerAndroidApplication() {
    ...
    override fun onCreate() {
        ...
        installDispatcher(MobileComponentBuilder)
        installDispatcher(TodoListComponentBuilder)
        installDispatcher(AddTodoComponentBuilder)
        installDispatcher(SettingsComponentBuilder)
        installDispatcher(BackupComponentBuilder)
